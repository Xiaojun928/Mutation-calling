...
{
  my $vcf_input = "$dir_out/Combo.rnd$boot.$type.pseudo.vcf";
  my $stats_output = "$dir_out/Combo.rnd$boot.$type.pseudo.mapq.tab";
  ...
  # R
  my $pdf_output = "$dir_out/Combo.rnd$boot.$type.pseudo.mapq.pdf";
